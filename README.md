...
Лендинг-портфолио FullStack-разработчика с рабочей формой обратной связи и ИИ-интеграцией.
...
| ИИ       | OpenRouter API openrouter/free                              |
...
**Почему openrouter/free:** задача простая (2-3 предложения), быстро и бесплатно.
